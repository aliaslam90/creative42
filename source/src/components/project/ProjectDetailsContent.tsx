            ...
            <div className="project-single-wrap">
                <div className="project-single-header">
                    <div className="section-header">
                        ...
                        <AnimatedText>
                            Every Creative42.ai project begins with perspective. We look beyond the expected brief, study the audience, and shape a creative direction that gives the brand a sharper line of sight.
                        </AnimatedText>
                    </div>
                </div>
