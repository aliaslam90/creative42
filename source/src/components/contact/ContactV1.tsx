                ...
                <div className="custom-row">
                    <div className="left">
                        <div className="contact-content">
                            ...
                            <p>
                                <span className="required">*</span> Whether you have a question or want to discuss a project, the Creative42.ai team is ready to help you find the sharper angle. Please fill out the form below.
                            </p>
